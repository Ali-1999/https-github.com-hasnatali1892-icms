...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="Home.php">New Choice Food</a>
            <!-- Sidebar Toggle-->
...
<main>
  ...
  <img src="assets/img/logo-2.png" class="rounded" alt="...">
</div>
<h1 class="text-lg-center" > <b> New Choice Food</b></h1>
    <div class="row">
      <div class="container">
      ...
      <footer class="py-4 bg-light mt-auto">
          <div class="container-fluid px-4">
              <div class="d-flex align-items-center justify-content-between small">
                  <div class="text-muted">Copyright &copy; ICE CREAM MANAGEMENT SYSTEM 2022</div>
                  <div>
