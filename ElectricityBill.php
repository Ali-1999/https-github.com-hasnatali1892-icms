...
include('Header.php')
 ...
 <main>
       ...
       <div class="table-wrapper">
         ...
         <div class="col-sm-6">
           <br><br>
           <a href="#add" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Bill</span></a>
           <a href="#deletestock" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete bill</span></a>
         </div>
               </div>
           </div>
             ...
             <div class="row">
               ...
               <div class="col">
                 <div class="form-group">
                   ...
                   <input class="form-control" type="text" name="Type" placeholder="Electricity Bill" value="Electricity Bill">
                 </div>
               </div>
             </div>
             <div class="row">
